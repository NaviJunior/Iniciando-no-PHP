                    ...
                    <div class="card-body">
                        ...
                        <form action="acoes.php" method="POST">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="date" name="data_nascimento" value="<?php echo $usuario['data_nascimento']; ?>" class="form-control">
                            </div>
                            <div class="mb-3">
                                <label>Senha</label>
                                <input type="password" name="senha" value="<?php echo $usuario['senha']; ?>" class="form-control">
                            </div>
                            <div class="mb-3">
